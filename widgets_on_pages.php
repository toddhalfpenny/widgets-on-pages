...
function wop_menu()
{
    ...
    $wop_plugin_hook = add_options_page(
...
function register_wop_settings()
{ // whitelist options
    ...
    <form method="post" action="options.php">
        ...
        <table class="form-table">
            ...
            <tr valign="top">
                ...
                <td>
                    <?php echo '<input name="wop_options_field[enable_css]" type="checkbox" value="1" class="code" ' . checked(
                    1,
                    $enable_css,
                    false
                ) . ' />';
            ...
            <tr valign="top">
                ...
                <td><input type='text' name="wop_options_field[num_of_wop_sidebars]" size='3'
                           value="<?php echo $num_add_sidebars;?>" onkeypress='validate(event)'/></td>
            </tr>
            ...
            <tr>
                <td><h3>Optional Sidebar Names</h3></td>
                <td></td>
            </tr>
            <?php
            for ($sidebar = 1; $sidebar <= ($num_add_sidebars + 1); $sidebar++) {
                ...
                <tr valign="top">
                    ...
                    <td><input type='text' name="wop_options_field[<?php echo $option_id;?>]" size='35'
                               value="<?php echo $options[$option_id];?>"/></td>
                </tr>
                <?php
            }
            ?>
            ...
            <tr>
                <td colspan='2'><h3>Rate this plugin</h3>

                    <p><a href="http://wordpress.org/support/view/plugin-reviews/widgets-on-pages?rate=5#postform"
                          title="Rate me">If you like me, please rate me</a>... or maybe even <a
                            href="http://gingerbreaddesign.co.uk/wordpress/" title="Show you love">donate to the
                        author</a>...

                    <p>

                    <p>or perhaps just spread the good word <a href="https://twitter.com/share"
                                                               class="twitter-share-button"
                                                               data-url="http://wordpress.org/extend/plugins/widgets-on-pages/"
                                                               data-text="Using the Widgets on Pages WordPress plugin and lovin' it"
                                                               data-via="toddhalfpenny" data-count="none">Tweet</a>
...
function widgets_on_page($atts)
{
    ...
    extract(
        ...
        if (is_numeric($id)) :
        $sidebar_name = 'Widgets on Pages ' . $id; else :
        $sidebar_name = $id;
    endif;
...
{
    echo "<link rel='stylesheet' id='wop-css'  href='" . get_option(
        'siteurl'
    ) . "/wp-content/plugins/widgets-on-pages/wop.css' type='text/css' media='all' />";
}
